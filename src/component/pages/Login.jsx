...
import loginImg from '../../assets/sign up.jpg'
...
function Login() {
  ...
  return (
    ...
    <div className='w-full mt-3 flex flex-col md:flex-row'>
      <div className="w-full hidden lg:inline-block md:px-28 mx-10 md:w-1/2">
        <img src={loginImg} alt="thumbLoginImg" width={400} height={400} />
      </div>
        <div className="w-full md:w-1/2 flex min-h-full flex-1 lg:mr-20 flex-col justify-center px-6 py-12 lg:px-8">
